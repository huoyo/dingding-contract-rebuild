...
public class ContractTemplateEntity extends BaseModel {
    ...
    @Column(name = "standTextNo",type = OracleTypeConstant.VARCHAR, isNull = false,comment = "标准文本编号")
    private String standTextNo;

    @TableField("version")
    @Column(name = "version",type = OracleTypeConstant.VARCHAR, isNull = false,comment = "版本编号")
    private String version;

    @TableField("filePath")
    @Column(name = "filePath",type = OracleTypeConstant.VARCHAR, isNull = false,comment = "文件路径,不包含任何一截前置路径")
    private String filePath;

    @TableField("standeTextName")
    @Column(name = "standeTextName",type = OracleTypeConstant.VARCHAR, isNull = false,comment = "标准文本名称")
    private String standeTextName;

    @Column(name = "standTextType", type = OracleTypeConstant.VARCHAR, isNull = false,comment = "标准文本类型")
    @TableField("standTextType")
    private String standTextType;

    @Column(name = "standTextOwnnerCorp", type = OracleTypeConstant.VARCHAR,comment = "标准文本所属公司")
    @TableField("standTextOwnnerCorp")
    private String standTextOwnnerCorp;

    @Column(name = "standTextOwnnerDept", type = OracleTypeConstant.VARCHAR,comment = "标准文本所属部门")
    @TableField("standTextOwnnerDept")
    private String standTextOwnnerDept;

    @Column(name = "standTextStatu", type = OracleTypeConstant.VARCHAR,comment = "标准文本状态")
    @TableField("standTextStatu")
    private String standTextStatu;

    @Column(name = "standTextProp", type = OracleTypeConstant.VARCHAR,comment = "标准文本属性")
    @TableField("standTextProp")
    private String standTextProp;

    @Column(name = "useageWide", type = OracleTypeConstant.VARCHAR,comment = "使用范围")
    ...
    @Column(name = "standTextCreator", type = OracleTypeConstant.VARCHAR,isNull = false, comment = "标准文本创建人")
    @TableField("standTextCreator")
    private String standTextCreator;

    @Column(name = "standTextDisc", type = OracleTypeConstant.VARCHAR, comment = "标准文本备注说明")

...
public class ContractInfoEntity extends BaseModel implements Serializable,EntityFatherForMerge{
    ...
    @Column(name = "contractNo",type = OracleTypeConstant.VARCHAR2,isNull = false,
            comment = "合同编码")
    @TableField("contractNo")
    private String contractNo;

    @Column(name = "contractName",type = OracleTypeConstant.VARCHAR2,isNull = false,
            comment = "合同名称")
    @TableField("contractName")
    private String contractName;

    @Column(name = "contractType",type = OracleTypeConstant.VARCHAR2,isNull = false,
            comment = "合同类型")
    @TableField("contractType")
    private String contractType;

    @Column(name = "ourSideEntity",type = OracleTypeConstant.VARCHAR2,isNull = false,
            comment = "我方主体")
    @TableField("ourSideEntity")
    private String ourSideEntity;

    @Column(name = "contractRunnerUserId",type = OracleTypeConstant.VARCHAR2,isNull = false,
            comment = "合同履行人钉钉userId")
    @TableField("contractRunnerUserId")
    private String contractRunnerUserId;

    @Column(name = "contractRunnerName",type = OracleTypeConstant.VARCHAR2,isNull = false,
            comment = "合同履行人姓名")
    @TableField("contractRunnerName")
    private String contractRunnerName;

    @Column(name = "contractRunningComment",type = OracleTypeConstant.VARCHAR2,
            comment = "合同履行人评论")
    @TableField("contractRunningComment")
    private String contractRunningComment;

    @Column(name = "theirEntityName",type = OracleTypeConstant.VARCHAR2,isNull = false,
            comment = "对方主体全称")
    @TableField("theirEntityName")
    private String theirEntityName;

    @Column(name = "theirQualityDingPanId",type = OracleTypeConstant.VARCHAR2,isNull = false,
            comment = "对方资质储存钉盘id")
    @TableField("theirQualityDingPanId")
    private String theirQualityDingPanId;

    @Column(name = "theirQualityFilePath",type = OracleTypeConstant.VARCHAR2,isNull = false,
            comment = "对方资质储存路径")
    @TableField("theirQualityFilePath")
    private String theirQualityFilePath;

    @Column(name = "standTemplateFileId",type = OracleTypeConstant.VARCHAR2,
            comment = "标准合同模板Id")
    @TableField("standTemplateFileId")
    private String standTemplateFileId;

    @Column(name = "useageOfStandTemplate",type = OracleTypeConstant.VARCHAR2,
            comment = "标准合同模板使用情况")
    @TableField("useageOfStandTemplate")
    private String useageOfStandTemplate;

    @Column(name = "standTemplateDingPanId",type = OracleTypeConstant.VARCHAR2,
            comment = "标准合同模板钉盘Id")
    @TableField("standTemplateDingPanId")
    private String standTemplateDingPanId;

    @Column(name = "standTemplateFilePath",type = OracleTypeConstant.VARCHAR2,
            comment = "标准合同模板储存路径")
    @TableField("standTemplateFilePath")
    private String standTemplateFilePath;

    @Column(name = "contractTextFilePath",type = OracleTypeConstant.VARCHAR2,isNull = false,
            comment = "合同正文储存路径")
    @TableField("contractTextFilePath")
    private String contractTextFilePath;

    @Column(name = "contractTextDingPanId",type = OracleTypeConstant.VARCHAR2,isNull = false,
            comment = "合同正文钉盘id")
    @TableField("contractTextDingPanId")
    private String contractTextDingPanId;

    @Column(name = "attachmentDingPanid1",type = OracleTypeConstant.VARCHAR2,
            comment = "附件1存储钉盘id")
    @TableField("attachmentDingPanid1")
    private String attachmentDingPanid1;

    @Column(name = "attachmentFilePath1",type = OracleTypeConstant.VARCHAR2,
            comment = "附件1存储路径")
    @TableField("attachmentFilePath1")
    private String attachmentFilePath1;

    @Column(name = "attachmentDingPanid2",type = OracleTypeConstant.VARCHAR2,
            comment = "附件2存储钉盘id")
    @TableField("attachmentDingPanid2")
    private String attachmentDingPanid2;

    @Column(name = "attachmentFilePath2",type = OracleTypeConstant.VARCHAR2,
            comment = "附件2存储路径")
    @TableField("attachmentFilePath2")
    private String attachmentFilePath2;

    @Column(name = "attachmentDingPanid3",type = OracleTypeConstant.VARCHAR2,
            comment = "附件3存储钉盘id")
    @TableField("attachmentDingPanid3")
    private String attachmentDingPanid3;

    @Column(name = "attachmentFilePath3",type = OracleTypeConstant.VARCHAR2,
            comment = "附件3存储路径")
    @TableField("attachmentFilePath3")
    private String attachmentFilePath3;

    @Column(name = "attachmentDingPanid4",type = OracleTypeConstant.VARCHAR2,
            comment = "附件4存储钉盘id")
    @TableField("attachmentDingPanid4")
    private String attachmentDingPanid4;

    @Column(name = "attachmentFilePath4",type = OracleTypeConstant.VARCHAR2,
            comment = "附件4存储路径")
    @TableField("attachmentFilePath4")
    private String attachmentFilePath4;

    @Column(name = "attachmentDingPanid5",type = OracleTypeConstant.VARCHAR2,
            comment = "附件5存储钉盘id")
    @TableField("attachmentDingPanid5")
    private String attachmentDingPanid5;

    @Column(name = "attachmentFilePath5",type = OracleTypeConstant.VARCHAR2,
            comment = "附件5存储路径")
    @TableField("attachmentFilePath5")
    private String attachmentFilePath5;

    @Column(name = "theWayTheyChoice",type = OracleTypeConstant.VARCHAR2,isNull = false,
            comment = "对方选择方式")
    @TableField("theWayTheyChoice")
    private String theWayTheyChoice;

    @Column(name = "theWayToPay",type = OracleTypeConstant.VARCHAR2,isNull = false,
            comment = "收付款方式")
    @TableField("theWayToPay")
    private String theWayToPay;

    @Column(name = "moneyWithOutTax",type = OracleTypeConstant.VARCHAR2,isNull = false,
            comment = "不含增值税合同额")
    @TableField("moneyWithOutTax")
    private String moneyWithOutTax;

    @Column(name = "taxRate",type = OracleTypeConstant.VARCHAR2,isNull = false,
            comment = "增值税税率")
    @TableField("taxRate")
    private String taxRate;

    @Column(name = "moneyOfTax",type = OracleTypeConstant.VARCHAR2,isNull = false,
            comment = "增值税税额")
    @TableField("moneyOfTax")
    private String moneyOfTax;

    @Column(name = "moneyWithTax",type = OracleTypeConstant.VARCHAR2,isNull = false,
            comment = "含增值税合同金额")
    @TableField("moneyWithTax")
    private String moneyWithTax;

    @Column(name = "deadlineForPerformance",type = OracleTypeConstant.VARCHAR2,isNull = false,
    ...
    @Column(name = "organizers",type = OracleTypeConstant.VARCHAR2,isNull = false,
            comment = "承办部门")
    @TableField("organizers")
    private String organizers;

    @Column(name = "organizerUserId",type = OracleTypeConstant.VARCHAR2,isNull = false,
            comment = "承办人钉钉userId")
    @TableField("organizerUserId")
    private  String organizerUserId;

    @Column(name = "organizerName",type = OracleTypeConstant.VARCHAR2,isNull = false,
            comment = "承办人姓名")
    @TableField("organizerName")
    private  String organizerName;

    @Column(name = "contactPhone",type = OracleTypeConstant.VARCHAR2,isNull = false,
            comment = "联系电话")
    @TableField("contactPhone")
    private  String contactPhone;

    @Column(name = "reviewerList",type = OracleTypeConstant.VARCHAR2,isNull = false,
            comment = "审批人userId列表")
    @TableField("reviewerList")
    private String reviewerList;

    @Column(name = "finalReviewerList",type = OracleTypeConstant.VARCHAR2,isNull = false,
            comment = "最终审批人userId")
    @TableField("finalReviewerList")
    private String finalReviewerList;

    @Column(name = "sign",type = OracleTypeConstant.NUMBER,
            comment = "合同管理员签章,1代表已完成")
    @TableField("sign")
    private int sign;

    @Column(name = "signName",type = OracleTypeConstant.VARCHAR2,
            comment = "签章人")
    @TableField("signName")
    private String signName;

    @Column(name = "save",type = OracleTypeConstant.NUMBER,
            comment = "合同管理员存档,1代表已完成")
    @TableField("save")
    private int save;

    @Column(name = "saveName",type = OracleTypeConstant.VARCHAR2,
            comment = "存档人")
    @TableField("saveName")
    private String saveName;

    //合同在履行时为running
    @Column(name = "statu",type = OracleTypeConstant.VARCHAR2,
            comment = "合同运行状态")
    @TableField("statu")
    private String statu;

    @Column(name = "preContractId",type = OracleTypeConstant.VARCHAR2,
            comment = "修改之前的原合同id")
    @TableField("preContractId")
    private String preContractId;

    @Column(name = "method",type = OracleTypeConstant.VARCHAR2,
            comment = "合同的操作方法")
    @TableField("method")
    ...
    @Column(name = "createdtime", type = OracleTypeConstant.DATE, isNull = false,comment = "创建时间")
    @TableField(value = "createdtime",fill = FieldFill.INSERT)
    protected Date createdtime;

    @Column(name = "updatetime", type = OracleTypeConstant.DATE, isNull = false,comment = "更新时间")
    @TableField(value = "updatetime",fill = FieldFill.INSERT_UPDATE)
    protected Date updatetime;

    @Column(name = "preEndComment", type = OracleTypeConstant.VARCHAR2,comment = "终止理由")
